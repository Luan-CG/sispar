...
function NavBar(){
    ...
    return(
        ...
        <section>
            ...
            <div>
            <button onClick={()=>{navigate("/reembolsos")}}><img src={Home} alt="" /></button>
            <button onClick={()=>{navigate("/solicitacao")}}><img src={Reembolso} alt="Botão rb" /></button>
            <button onClick={()=>{navigate("/reembolsos")}}><img src={Pesquisa} alt="" /></button>
            <button onClick={()=>{navigate("/solicitacao")}}><img src={Historico} alt="" /></button>    
            </div>
        </section>

        <button className={styles.buttonSair} onClick={()=>{navigate("/")}}><img src={Sair} alt="" /></button>
